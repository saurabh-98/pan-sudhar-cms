...
use App\Http\Requests\PanApplyWithoutDocumentRequest;
use App\Http\Requests\UpdatePanApplyWithoutDocumentRequest;
...
class PanApplyWithoutDocumentController extends Controller
{
   

    public function __construct(

    protected PanApplyWithoutDocumentService $panApplyWithoutDocumentService,
    ...
    private function getPanApplyWithoutDocumentCharge(): float
    {
    ...
    public function index()
    {
        if (request()->ajax()) {
            ...
            $applications = PanWithoutDocument::query()
                    ...
                    return '
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <a
                                ...
                                . route(
                                    'retailer.pan-apply-without-document.show',
                                    $row->id
                                )
        ...
        return view(
            'retailer.pan-apply-without-document.history'
        );
    }
    ...
    */
    ...
    {
        $preview = get_pan_apply_without_document_session();
        ...
        return view(
            ...
            'retailer.pan-apply-without-document.apply',
            ...
            [
                ...
                'panCharge' =>
                    ...
                    $this->getPanApplyWithoutDocumentCharge(),
    ...
    public function preview(
        PanApplyWithoutDocumentRequest $request
    ): JsonResponse {
        ...
        try {
            ...
            $panCharge = $this->getPanApplyWithoutDocumentCharge();
            ...
            if ($panCharge <= 0) {
                ...
                return response()->json([
                    ...
                    'message' => 'PAN Apply Without Document  charge is not configured.'
            ...
            $dto = PanWithoutDocumentDTO::fromRequest(
                $request
            );

            $preview = $this->panApplyWithoutDocumentService
                ->preview($dto);
            ...
            */
            ...
            return response()->json([
                ...
                'redirect_url' =>
                    ...
                    route(
                        'retailer.pan-apply-without-document.preview-page'
                    )
    ...
    public function previewPage()
    {
        ...
        return view(
            ...
            'retailer.pan-apply-without-document.preview',
    ...
    public function finalSubmit(): JsonResponse
    {
        ...
        try {
            ...
            */
            ...
            $application = $this->panApplyWithoutDocumentService
                ->storeFromSession();
            ...
            */
            ...
            WalletTransaction::create([
                ...
                'remark'          =>
                    'PAN Apply Without Document Application Charge'
            ...
            */
            ...
            WalletTransaction::create([
                ...
                'remark'          =>
                    'PAN Apply Without Document Application Received Amount'
            ...
            return response()->json([
                ...
                'message'      =>
                    'PAN Apply Without Document Application Submitted Successfully.',

                'redirect_url' => route(
                    'retailer.pan-apply-without-document.receiving',
                    $application->id
                )
            ...
            Log::error(
                'PAN APPLY WITHOUT DOCUMENT FINAL SUBMIT ERROR',
                [
                    'message' => $e->getMessage(),
                    'line'    => $e->getLine(),
                    'file'    => $e->getFile()
    ...
    public function show(int $id)
    {
        return view(
            ...
            [
                ...
                $this->panApplyWithoutDocumentService->find(
                    $id,
                    auth()->id()
                )
    ...
    */
    ...
    public function edit(int $id)
    {
        return view(
            ...
            'retailer.pan-apply-without-document.edit',
    ...
    */
    ...
    public function update(
        UpdatePanApplyWithoutDocumentRequest $request,
        int $id
    )
    {
       $this->panApplyWithoutDocumentService->update(
        ...
        return redirect()
            ...
            ->with(
                ...
                'PAN Application Without Document Updated Successfully.'
    ...
    */
    ...
    {
        $this->panApplyWithoutDocumentService->delete(
        ...
        return redirect()
            ...
            ->with(
                ...
                'PAN Application Without Document Deleted Successfully.'
    ...
    */
    ...
    public function status(int $id)
    {
        return view(
            ...
            'retailer.pan-application-without-document.status',
    ...
    */
    ...
    public function acknowledgement(int $id)
    {
        ...
        return view(
            ...
            'retailer.pan-apply-without-document.acknowledge',
    ...
    */
    ...
    public function print(int $id)
    {
        return view(
            ...
            'retailer.pan-apply-without-document.print',
