...
class AdminVoterIdController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.voter-id.index');
    }
    ...
    */
    ...
    public function show(int $id): View
    {
        ...
        */
        ...
        $application = VoterIdService::query()
    ...
    */
    ...
    public function assign(
        ...
        $application = VoterIdService::findOrFail(
            $id
        );
        ...
        return response()->json([
            ...
            'message' => 'Voter-Id Service Assigned Successfully.',
    ...
    */
    ...
    )
    {
        ...
        */
        ...
        $application = VoterIdService::findOrFail($id);
    ...
    {
        $application = VoterIdService::with([
            'serviceDocuments.user'
        ])->findOrFail($id);
        ...
        foreach (
            ...
            try {
                ...
                logger()->error(
                    ...
                    'VOTER-ID EXECUTIVE DOCUMENT ZIP ERROR',
...
try {
    ...
    $application = VoterIdService::lockForUpdate()
        ->findOrFail($id);
    ...
    if (
        ...
        */
        ...
        WalletTransaction::create([
            ...
            'remark'           =>
                'Refund received for Voter-Id Service Application No. '
                . $application->application_no
    ...
    */
    ...
    return back()->with(
        'success',
        'Voter-id Service application rejected and amount refunded successfully.'
    );
