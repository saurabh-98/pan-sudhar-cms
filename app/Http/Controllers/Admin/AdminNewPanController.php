    ...
    */
    ...
    public function reject($id)
    {
        try {
            ...
            $application = PanApplication::lockForUpdate()
                ->findOrFail($id);
            ...
            if (
                ...
                */
                ...
                WalletTransaction::create([
                    ...
                    'transaction_type' => 'pan_refund',

                    'remark' =>
                        'Refund debited for PAN Application No. '
                        . $application->application_no
                ...
                */
                ...
                WalletTransaction::create([
                    ...
                    'remark' =>
                        'Refund received for PAN Application No. '
                        . $application->application_no
            ...
            */
            ...
            return back()->with(
                'success',
                'PAN application rejected and amount refunded successfully.'
            );
