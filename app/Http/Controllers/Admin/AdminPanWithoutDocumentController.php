...
class AdminPanWithoutDocumentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.pan-without-document.index');
    }
    /*
    |--------------------------------------------------------------------------
    | SHOW APPLICATION
    ...
    */
    ...
    {
        $application = PanWithoutDocument::query()
    ...
    */
    ...
    public function assign(
        ...
        */
        ...
        $application = PanWithoutDocument::findOrFail(
            $id
        );
        ...
        */
        ...
        return response()->json([
            ...
            'message' => 'PAN Without Document Application Assigned Successfully.',
   ...
   public function uploadDocument(Request $request, int $id)
    {
        ...
        */
        ...
        $application = PanWithoutDocument::findOrFail($id);
        ...
        */
        ...
        $alreadyUploaded = ServiceDocument::where([
            'service_type' => 'pan_without_document',
        ...
        */
        ...
        $path = store_uploaded_file(
            ...
            'service-documents/pan-without-docs'
        );
        ...
        */
        ...
        $this->financialSettlementService->settle(
            ...
            remarks: 'PAN Without Document Settlement'
        ...
        */
        ...
        return response()->json([
            ...
            'message'  => 'PAN Without Document receipt uploaded successfully.',
   ...
   public function downloadDocuments(int $id)
{
    ...
    */
    ...
    $application = PanWithoutDocument::with(
        'documents'
    )->findOrFail($id);
    ...
    */
    ...
    public function reject($id)
    {
        try {
            ...
            $application = PanWithoutDocument::lockForUpdate()
                ->findOrFail($id);
            ...
            if (
                ...
                */
                ...
                WalletTransaction::create([
                    ...
                    'transaction_type' => 'pan_without_document_refund',

                    'remark' =>
                        'Refund debited for PAN Without Document Application No. '
                        . $application->application_no
                ...
                */
                ...
                WalletTransaction::create([
                    ...
                    'remark' =>
                        'Refund received for PAN Without Document Application No. '
                        . $application->application_no
            ...
            */
            ...
            return back()->with(
                'success',
                'PAN Without Document application rejected and amount refunded successfully.'
            );
