    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <p class="admin-pan-subtitle">
                Verify, review and assign Other service application.
            </p>
        ...
        <div class="d-flex gap-2 flex-wrap">
           ...
           <a
                href="{{ route('admin.other-service.index') }}"
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="pan-info-box">
                                ...
                                <h6>{{ $application->application_no }}</h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="pan-info-box">
                                ...
                                <h6>{{ $application->service_name }}</h6>
                        ...
                        <div class="card admin-pan-card mb-4">
                            ...
                            <div class="card-header pan-card-header">
                                ...
                                <button
                                    ...
                                    data-url="{{ route('admin.other-service.download.documents',$application->id) }}"
                                >
                            ...
                            <div class="card-body">
                                ...
                                <div class="row g-4">
                                   ...
                                   @foreach(($application->documents ?? []) as $key => $file)
            ...
            {{-- ======================================================
                ...
                <div class="col-xl-4">
                        ...
                        <div class="card admin-pan-card sticky-top action-panel-card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.other-service.assign', $application->id) }}"
                                    method="POST"
                                >
                                    ...
                                    <div class="mb-4">
                                        ...
                                        >{{ old('remarks', $application->admin_remarks) }}</textarea>
                    ...
                    @if(
                        ...
                        &&
                        $application->serviceDocuments->count() == 0
                    )
                        ...
                        <div class="card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.other-service.document.upload', $application->id) }}"
                                    method="POST"
                ...
                {{-- ======================================================
                        ...
                        ====================================================== --}}
                        @if($application->serviceDocuments->count())
                        ...
                        <div class="card border-0 shadow-lg">
                            ...
                            <div class="card-body">
                                ...
                                @foreach($application->serviceDocuments as $doc)

                                    <div class="uploaded-doc-card p-3 border rounded shadow-sm mb-3">
    ...
    $('#assignApplicationForm').on('submit', function (e) {
        ...
        */
        ...
        Swal.fire({
            ...
            text: 'Do you want to assign this Other Service application?',
                        ...
                        Swal.fire({
                            ...
                            */
                            ...
                            window.location.href =
                                "{{ route('admin.other-service.index') }}";
