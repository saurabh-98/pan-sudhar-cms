    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <h2 class="admin-pan-title">
                Finance Other Service Applications
            </h2>

            <p class="admin-pan-subtitle">
                Manage Finance Other Service applications and assign them professionally.
            </p>
...
$(function () {
    ...
    $('#financeOtherServiceTable').DataTable({
        ...
        ajax: "{{ route('admin.other-service.finance.index') }}",
        ...
        language: {
            ...
            searchPlaceholder: "Search Finance Other Service...",
