    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <p class="admin-pan-subtitle">
                Verify, review and assign Csc service application.
            </p>
                        ...
                        <div class="card admin-pan-card mb-4">
                            ...
                            <div class="card-header pan-card-header">
                                ...
                                <button
                                    ...
                                    data-url="{{ route('admin.csc.download.documents',$application->id) }}"
                                >
                        ...
                        <div class="card admin-pan-card sticky-top action-panel-card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.csc.assign', $application->id) }}"
                                    method="POST"
                                >
                        ...
                        <div class="card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.csc.document.upload', $application->id) }}"
                                    method="POST"
    ...
    $('#assignApplicationForm').on('submit', function (e) {
        ...
        */
        ...
        Swal.fire({
            ...
            text: 'Do you want to assign this Csc application?',
