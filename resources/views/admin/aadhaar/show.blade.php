    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <h2 class="admin-pan-title">
                Aadhaar Service Details
            </h2>

            <p class="admin-pan-subtitle">
                Verify, review and assign Aadhaar service application.
            </p>
        ...
        <div class="d-flex gap-2 flex-wrap">
           ...
           <a
                href="{{ route('admin.aadhaar.index') }}"
                        ...
                        <div class="card admin-pan-card mb-4">
                            ...
                            <div class="card-header pan-card-header">
                                ...
                                <button
                                    ...
                                    data-url="{{ route('admin.aadhaar.download.documents',$application->id) }}"
                                >
                        ...
                        <div class="card admin-pan-card sticky-top action-panel-card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.aadhaar.assign', $application->id) }}"
                                    method="POST"
                                >
                        ...
                        <div class="card border-0 shadow-lg mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form
                                    ...
                                    action="{{ route('admin.aadhaar.document.upload', $application->id) }}"
                                    method="POST"
    ...
    $('#assignApplicationForm').on('submit', function (e) {
        ...
        */
        ...
        Swal.fire({
            ...
            text: 'Do you want to assign this Aadhaar application?',
