    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <h2 class="admin-pan-title">
                ...
                PAN Correction Application Details
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a
                href="{{ route('admin.pan-correction.index') }}"
                ...
                <div class="card admin-pan-card">
                    ...
                    <div class="card-header pan-card-header">
                        ...
                        <button
                            ...
                            data-url="{{ route('admin.pan-correction.new.download.documents', $application->id) }}"
                        >
            ...
            <div class="card admin-pan-card sticky-top action-panel-card border-0 shadow-lg mb-4">
                ...
                <div class="card-body">
                    ...
                    <form
                        ...
                        action="{{ route('admin.pan-correction.assign', $application->id) }}"
                        method="POST"
                    >
            ...
            <div class="card border-0 shadow-lg mb-4">
                ...
                <div class="card-body">
                    ...
                    <form
                        ...
                        action="{{ route('admin.pan-correction.document.upload', $application->id) }}"
                        method="POST"
                        ...
                        Swal.fire({
                            ...
                            */
                            ...
                            window.location.href =
                                "{{ route('admin.pan-correction.index') }}";
