    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <h2 class="admin-pan-title">
                ...
                TDS Application Details

            </h2>

            <p class="admin-pan-subtitle">

                Verify, review and assign TDS application.
            ...
            <div class="card admin-pan-card">
                ...
                <div class="card-header pan-card-header d-flex justify-content-between align-items-center">
                    ...
                    <button
                        ...
                        data-url="{{ route('admin.tds.download.documents', $application->id) }}"
                    >
                ...
                @if(auth()->user()->hasRole('admin'))
                    ...
                    <div class="card admin-pan-card sticky-top action-panel-card">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                id="assignItrForm"
                                action="{{ route('admin.tds.assign', $application->id) }}"
                                method="POST"
                            >
                    ...
                    <div class="card border-0 shadow-lg mt-4">
                        ...
                        <div class="card-body">
                            ...
                            <form
                                ...
                                action="{{ route('admin.tds.document.upload', $application->id) }}"
                                method="POST"
    ...
    */
    ...
    $('#assignItrForm').on('submit', function (e) {
        ...
        Swal.fire({
            ...
            text: 'Do you want to assign this TDS application?',
