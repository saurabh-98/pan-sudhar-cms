    ...
    <div class="admin-pan-header">
        ...
        <div>
            ...
            <h2 class="admin-pan-title">
                ...
                PAN Without Documents Application Details

            </h2>

            <p class="admin-pan-subtitle">

                Verify, review and assign PAN Without Documents application.
        ...
        <div class="d-flex gap-2 flex-wrap">
            ...
            <a
                href="{{ route('admin.pan-without-docs.index') }}"
                ...
                <div class="card admin-pan-card">
                    ...
                    <div class="card-header pan-card-header">
                        ...
                        <button
                            ...
                            data-url="{{ route('admin.pan-without-docs.new.download.documents', $application->id) }}"
                        >
            ...
            <div class="card admin-pan-card sticky-top action-panel-card border-0 shadow-lg mb-4">
                ...
                <div class="card-body">
                    ...
                    <form
                        ...
                        action="{{ route('admin.pan-without-docs.assign', $application->id) }}"
                        method="POST"
                    >
            ...
            <div class="card border-0 shadow-lg mb-4">
                ...
                <div class="card-body">
                    ...
                    <form
                        ...
                        action="{{ route('admin.pan-without-docs.document.upload', $application->id) }}"
                        method="POST"
    ...
    $('#assignApplicationForm').on('submit', function (e) {
        ...
        */
        ...
        Swal.fire({
            ...
            text: 'Do you want to assign this PAN Without Docs application?',
                        ...
                        Swal.fire({
                            ...
                            */
                            ...
                            window.location.href =
                                "{{ route('admin.pan-without-docs.index') }}";
