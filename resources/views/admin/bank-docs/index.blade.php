            ...
            >
                ...
                <div class="mb-3">
                    ...
                    <small class="text-muted">
                        Required when creating a new docs. Leave empty on edit to keep the existing file.
                    </small>
...
$(document).ready(function(){
    ...
    let table = $('#serviceGuidelineTable').DataTable({
        ...
        ajax: "{{ route('admin.bank-docs.list') }}",
    ...
    $(document).on('click', '.editBtn', function(){
        ...
        $.ajax({
            ...
            url: "{{ route('admin.bank-docs.edit', ':id') }}"
                    .replace(':id', id),
    ...
    $('#serviceGuidelineForm').on('submit', function(e){
        ...
        let url = id
            ...
            ? "{{ route('admin.bank-docs.update', ':id') }}"
                .replace(':id', id)

            : "{{ route('admin.bank-docs.store') }}";
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.bank-docs.destroy', ':id') }}"
                            .replace(':id', id),
