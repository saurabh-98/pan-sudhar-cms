    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-3">
        ...
        <div>
            ...
            <h2 class="fw-bold mb-1 text-primary">
                ...
                PAN Without Docs Preview

            </h2>

            <p class="text-muted mb-0">

                Verify PAN without docs details before final submission.
        ...
        <div class="card-body p-4 p-lg-5">
          ...
          {{-- =====================================================
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mt-5">
                ...
                <form
                    action="{{ route('retailer.pan-apply-without-document.apply') }}"
                    method="GET"
                >
    ...
    Swal.fire({
        ...
        if(result.isConfirmed)
        {
            ...
            $.ajax({
                ...
                url: "{{ route('retailer.pan-apply-without-document.store') }}",
