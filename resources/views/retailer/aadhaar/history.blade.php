...
<div class="history-header">
    ...
    <div>
        ...
        <h2 class="history-title">
            ...
            Aadhaar Service History

        </h2>

        <p class="history-subtitle">

            View all submitted Aadhaar service applications,
    ...
    <a
        href="{{ route('retailer.aadhaar.service',['service'=>'mobile-number-update']) }}"
...
$(function(){
    ...
    $('#aadhaarHistoryTable').DataTable({
        ...
        ajax: "{{ route('retailer.aadhaar.history') }}",
