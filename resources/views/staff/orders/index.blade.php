...
let statusRoute   = "{{ route('staff.orders.status', ['id' => ':id']) }}";
let showRoute     = "{{ route('staff.orders.show', ['id' => ':id']) }}"; // ✅ FIXED
let paymentRoute  = "{{ route('staff.orders.payment', ['id' => ':id']) }}";
let invoiceRoute  = "{{ route('staff.orders.invoice', ['id' => ':id']) }}";
let downloadRoute = "{{ route('staff.orders.invoice.download', ['id' => ':id']) }}";
